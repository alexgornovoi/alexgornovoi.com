...
export const experience: ExperienceItem[] = [
  {
    ...
    roles: [
      {
        id: "cigna-senior-lead-analyst",
        title: "Software Engineering Lead Analyst",
        dates: "May 2026 - Present",
        description: "Building enterprise AI solutions on the AI Innovations and Platform team that enable senior leadership and internal analytics teams to ask natural language questions against real company data.",
        longDescription: "On the AI Innovations and Platform team, I work on enterprise-level projects that enable senior leadership and internal data analytics teams to ask natural language questions directly against real company data. By connecting to both internal data ecosystems and external real-world data sources, these solutions go beyond surfacing metrics. They provide context and reasoning for why those metrics look the way they do, helping decision makers understand not just what the numbers are, but why.",
        highlights: [
          "Building AI systems that allow senior leadership and analytics teams to query company data through natural language",
          "Connecting internal data ecosystems with external real-world data sources to enrich insights",
          "Enabling teams to derive metrics and understand the reasons behind them, not just the numbers themselves",
          "Developing end-to-end data pipelines and interfaces supporting enterprise-scale AI workflows",
        ],
      ...
      },
      {
        ...
        description: "Built end-to-end data pipelines and AI solutions within the AI Innovations and Platform team.",
        longDescription: "As a Software Engineering Senior Analyst on the AI Innovations and Platform team, I built end-to-end data pipelines that processed information from diverse sources, handling both backend infrastructure and frontend interfaces. My work focused on creating scalable AI solutions that integrated with enterprise systems.",
        highlights: [
          "Built end-to-end data pipelines processing data from multiple enterprise sources",
          "Developed both backend services and frontend interfaces for AI applications",
          "Integrated with enterprise data sources and APIs",
          "Contributed to the Enterprise Context Model architecture",
          "Helped the team get set up with AWS SageMaker for training and deploying machine learning models",
        ],
        technologies: ["Python", "LangChain", "AWS", "SageMaker", "RAG", "OpenAI", "Vector Databases"],
      },
      {
        id: "cigna-sre",
